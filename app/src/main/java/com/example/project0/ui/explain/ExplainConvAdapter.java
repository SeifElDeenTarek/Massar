...
public class ExplainConvAdapter extends RecyclerView.Adapter<ExplainConvAdapter.ExplainConvViewHolder>
{
    List<ExplainConvModel> explainModels = new ArrayList<>();
    itemClickListener itemClickListener;
    boolean Clicked3 = true;

    @NonNull
    @Override
    public ExplainConvViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        return new ExplainConvViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.explain_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ExplainConvViewHolder holder, int position)
    {
    ...
    {
        void onItemClick(ExplainConvModel explainModel);
    }

    public void setList(List<ExplainConvModel> explainModels, itemClickListener itemClickListener)
    {
    ...
    public class ExplainConvViewHolder extends RecyclerView.ViewHolder
    {
        TextView german, arabic, germanVoice;
        MaterialCardView card1, card2, card3;
        ImageView image1, image2, image3;

        public ExplainConvViewHolder(@NonNull View itemView)
        {
            super(itemView);
