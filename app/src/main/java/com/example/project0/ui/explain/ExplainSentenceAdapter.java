...
public class ExplainSentenceAdapter extends RecyclerView.Adapter<ExplainSentenceAdapter.ExplainSentenceViewHolder>
{
    List<ExplainSentenceModel> explainModels = new ArrayList<>();
    itemClickListener itemClickListener;
    boolean Clicked3 = true;

    @NonNull
    @Override
    public ExplainSentenceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        return new ExplainSentenceViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.explain_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ExplainSentenceViewHolder holder, int position)
    {
    ...
    {
        void onItemClick(ExplainSentenceModel explainModel);
    }

    public void setList(List<ExplainSentenceModel> explainModels, itemClickListener itemClickListener)
    {
    ...
    public class ExplainSentenceViewHolder extends RecyclerView.ViewHolder
    {
        TextView german, arabic, germanVoice;
        MaterialCardView card1, card2, card3;
        ImageView image1, image2, image3;

        public ExplainSentenceViewHolder(@NonNull View itemView)
        {
            super(itemView);
